...
## Issue tracker
bidu uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [bidu boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [infradev/bidu/issues][issues].
...
### Write Documentation
Bidu Dependency Injection could always use more documentation, whether as part of the official Bidu Dependency Injection docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `Bidu Dependency Injection` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [infradev/bidu][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/bidu.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on bidu coding standards.
...
[issues]: https://github.com/infradev/bidu/issues
[repo]: https://github.com/infradev/bidu
[repo-boards]: https://github.com/infradev/bidu/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/infradev/bidu/pull_requests
