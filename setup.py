...
setup(
    ...
    description='Bidu Python dependency injection framework, inspired by Guice.',
    long_description=parse_readme(),
    # What does your project relate to? Separate with spaces.
    keywords='bidu development',
    author='Alexandre Souza',
    author_email='alexandre@infradev.com.br',
    license='MIT',

    # The project's main homepage
    url='https://github.com/infradev/bidu',
